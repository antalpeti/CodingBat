package java.com.codingbat.ap1;
...
public class AP1 {
   ...
   */
  public String[] wordsFront(String[] words, int number) {
   ...
   * @return true, if the above mentioned conditions fulfilled
   */
  public boolean dividesSelf(int number) {
    int dividend = number;
    while (dividend != 0) {
   ...
   * @return the above mentioned new array
   */
  public int[] copyEvens(int[] numbers, int count) {
   ...
   * @return the above mentioned new array
   */
  public int[] copyEndy(int[] numbers, int count) {
   ...
   * @return the above mentioned number
   */
  public int scoresSpecial(int[] aScores, int[] bScores) {
   ...
   * @return the above mentioned number
   */
  public int findLargestSpecialScore(int[] scores) {
    int maxScore = 0;
   ...
   * @return the above mentioned number
   */
  public int bigHeights(int[] heights, int startIndex, int endIndex) {
    int bigSteps = 0;
