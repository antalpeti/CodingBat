package main.java.com.codingbat.array2;
...
public class Array2 {
  ...
  public int[] withoutTen(int[] numbers) {
    ...
    for (int i = notTenElementIndex; i < numbers.length; i++) {
      boolean elementIsNotTen = numbers[i] != 10;

      if (elementIsNotTen) {
        shiftedElements[notTenElementIndex++] = numbers[i];
      }
    }
  ...
  /**
   * Consider the series of numbers beginning at start and running up to but not including end, so
   * for example start=1 and end=5 gives the series 1, 2, 3, 4. Return a new String[] array
  ...
  public String[] fizzBuzz(int startNumber, int endNumber) {
    ...
    for (int number = startNumber; number < endNumber; number++) {
      if (number % 3 == 0 && number % 5 == 0) {
        fizzBuzzNumbers[fizzBuzzNumberIndex] = "FizzBuzz";
      } else if (number % 3 == 0) {
        fizzBuzzNumbers[fizzBuzzNumberIndex] = "Fizz";
      } else if (number % 5 == 0) {
        fizzBuzzNumbers[fizzBuzzNumberIndex] = "Buzz";
      } else {
        fizzBuzzNumbers[fizzBuzzNumberIndex] = String.valueOf(number);
      }
      fizzBuzzNumberIndex++;
    }
