package test.java.com.codingbat.warmup1;

import main.java.com.codingbat.warmup1.Warmup1;
...
public class Warmup1Test {
  ...
  private static Warmup1 instance;
  ...
  /**
   * Test method for {@link Warmup1#max1020(int, int)}.
   */
  @Test
  public void testMax1020() {
    // both of them in range
    Assert.assertEquals(19, instance.max1020(11, 19));
